...
from core.download_utils import download_and_extract_plugin, download_plugins_from_gdrive_folder
...
def main():
    ...
    PluginName = ["ConvAI", "ConvaiHTTP", "ConvaiPakManager", "JsonBlueprintUtilities"]
